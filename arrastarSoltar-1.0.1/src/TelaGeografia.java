...
public class TelaGeografia extends AnchorPane {
    ...
    public void mostrar(Stage stage) {
        ...
        stage.setTitle("Geografia");

        // Criando as palavras em um GridPane
        GridPane gridPane = new GridPane();
        gridPane.setHgap(50);
        gridPane.setVgap(50);
        gridPane.addRow(0, new Label("Geografia"), new Label("Bird"), new Label("Dolphin"), new Label("Monkey"));
